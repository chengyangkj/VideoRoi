...
QT_MOC_LITERAL(4, 28, 15) // "StopPointSignal"
    ...
    "MyLabel\0StartPointSignal\0\0p\0StopPointSignal"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->StartPointSignal((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: _t->StopPointSignal((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyLabel::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::StartPointSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyLabel::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::StopPointSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::StartPointSignal(QPoint _t1)
{
...
// SIGNAL 1
void MyLabel::StopPointSignal(QPoint _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
